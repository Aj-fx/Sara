...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('sᴀʀᴀ ᴡᴏʀᴋɪɴɢ ' + config.WORKTYPE + ' 𝚗𝚘𝚠 🧚'));
    ...
    setInterval(async () => { 
        ...
        var ansk = 'https://gist.github.com/ajayancr/990794cbe26dd78db7e68c0d364a5c8c/raw'
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ sᴀʀᴀ ~______~*' +
                                    '\n*🌀 fallow this page other wise chance to get erorr: https://instagram.com/_aj_cutzz?utm_medium=copy_link*' +
                                    '\n\n*⚠️ ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
