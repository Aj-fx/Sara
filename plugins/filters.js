...
const array = ['Amal','caption','Mrng','alive','Di','Bro','amal','avan','converting','Amalser','Allah','bg','help','Hii','odiko','oho','killadi','oo','Fuck','invite','Hi','love','Owner','Group','list','man','Nanba','oii','poda','yo','sad','work','set','remove','thukum','poko','myre,','kundan','xmedia','commands','Boss','vava','Myre','Lalitha','start','Adithhari','sing','Hello','Bye','warn','Baby','who','find','power','myr','vanam','tagall','Re entry','pass','patti','phaa','mone','look','bor','try','owner','luv','feel','romam','set','potte','no replay','bgm','vijay','poli','aj cutzz','ajayan','bot noobe','bot family','business','chat','com','cristiano','git','good','hacker','hello','hi','indo','kaztro','kollam','kollamo','line','lalettan','love me','mm','moodesh','mp3','muthe','myr','nanban','nanbans','noorin shereef','noorin','of','off','photo','potte','Rip','ronaldo','school','sed life','seen','sex','single','song','spam','umma','welcome','wine','you','bot','gm','Sara bot','Aj','Ajayan','Alfred','Aliya','Ano','Araa','Ayin','Baa','Bey','Bgmi','Black','Blaze boss','Blind','Block','Bomb','Bot sed','By','Call','Chunk uyir','Chunk','Chunks','Cristiano','Da','Daa','Darshana','Dj','Do','E bull jet','Eda','Editing','Ee','Eee','Ellam poyi','Entea aniyan kuttan','Exam','From','Fuhad','Full','Girl','Good night','Hacker','Hai','Help','Hum','Humm','I love you','I','Idd','Indo','Ividea','Kaliyannam','Kanjavu','Kannan','Kannapii','Kannappi','Karayallea','Kgf','Kili','KING sed','Kiss','Kozhi','Kudea','Kundan','Kutta','Kuttu','Line potti','Line undo','Loo','Love vendada','Love you bot','Love you molu','Love','Mamma','Mine','Mm','Mood of','Mood','Muthu','Myr','Myre','Nadakko','Nanban uyir','Nb','Nee','Njan ano','Njan eilla','Njan ind','Njan killadi alle','Njan nannayi','Njan poyi','Njan seen ane','Njan verum','Njr','No g','No','Noorin','Noorin shereef','Of','Ohh','Oii','Ok','No','Onam','Onn','Oo','Op','Ozhivaki','Paavam','Pavam','Pinne','Poda','Podimon','Polayat','Poli','Pova','Power','Powli','Pro','Pubg','Re','Remix','Ronaldo','Sara','Sed life','Set','Sex','Singel','Sir','Smile','Sorry','Srg','Supper','Thayoli','Theap','Theri','Tq','Umb','Umbi','Uyir','Va','Vaa','Vadaa','Vid','Video','Yedhu','You','Bot','Aa','Alone','home','Kaztro','5','4','group','Ha','Nanban','Pm','report','sara','Breakup','https','Sed','uyir','error','bro']
array.map( async (a) => {
